...
function TreeExpand($Parent,$table,$partable,$Folder0,$Page,$level,$levelexpand){
  ...
  while(list($key,$val)=each($list)){
	...
	$result.="<img style='border:1px solid black;' src='./Pics/folder.gif'><span style='vertical-align:35%;'>&nbsp;<a href='?Page=".$Folder0[$key]["ID"]."&dir=".$Folder0[$key]["Description"]."'>".$Folder0[$key]["Name"]."</a></span><br>"; 
      }
