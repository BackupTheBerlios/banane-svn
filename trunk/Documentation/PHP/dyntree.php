...
function TreeNodes($ID,$table,$partable,$Folder0,$Page,$levels){
  ...
  $imgfolder0="<img src='./Pics/folder.gif' alt='' width='20' height='20'>&nbsp;<span style='style='vertical-align:35%;'>";
  $imgfolder1="<img src='./Pics/folderopen.gif' alt='' width='20' height='20'>&nbsp;<span style='font-weight:bold;style='vertical-align:35%;'>";
  if(isset($table[$ID])) {
...
function TreeExpand($Parent,$table,$partable,$Folder0,$Page,$level,$levelexpand){
  ...
  while(list($key,$val)=each($list)){
	...
	$result.="<img src='./Pics/folder.gif'><span style='vertical-align:35%;'>&nbsp;<a href='?Page=".$Folder0[$key]["ID"]."&dir=".$Folder0[$key]["Description"]."'>".$Folder0[$key]["Name"]."</a></span><br>"; 
      }
