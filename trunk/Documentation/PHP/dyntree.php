...
function TreeExpand($Parent,$table,$partable,$Folder0,$Page,$level,$levelexpand){
  ...
  while(list($key,$val)=each($list)){
	...
	$result.="<span style='height:25px; vertical-align:center;'><img src='./Pics/folder.gif'>&nbsp;<a href='?Page=".$Folder0[$key]["ID"]."&dir=".$Folder0[$key]["Description"]."'>".$Folder0[$key]["Name"]."</a></span><br>"; 
      }
