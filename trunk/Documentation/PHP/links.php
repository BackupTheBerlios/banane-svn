...
echo "<map name='mymap'>";
echo " <area target='_top' href='mainpage.php' title='banane mainpage' alt='banane' shape=rect coords='10,15,135,150'>";
echo " <area target='_blank' href='http://developer.berlios.de' title='berliOS developer' alt='berliOS' shape=rect coords='10,500,135,600'>";
echo "</map>";
