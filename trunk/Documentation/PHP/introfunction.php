...
function introtext()
{
  ...
  $output.="<P>At the moment this web page is not working properly with Microsoft's Internet Explorer. For this an other reasons we strongly recommend to use Mozilla Firefox.";
